...
describe('color', () => {
	...
	describe('getColorName', () => {
		it('should give a name for a color', () => {
			expect(getColorName('#222222')).toEqual('black');
			expect(getColorName('#DDDDDD')).toEqual('white');
			expect(getColorName('#CCCCCC')).toEqual('grey');
			expect(getColorName('#FF1100')).toEqual('red');
			expect(getColorName('#FFFF00')).toEqual('yellow');
			expect(getColorName('#00FF00')).toEqual('green');
			expect(getColorName('#00FFFF')).toEqual('cyan');
			expect(getColorName('#0000FF')).toEqual('blue');
			expect(getColorName('#FF00FF')).toEqual('magenta');
			expect(getColorName('#FF0011')).toEqual('red');
		});
	});
});
