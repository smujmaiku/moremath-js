...
describe('color', () => {
	...
	describe('fadeColorByDistance', () => {
		...
		it('should fade to color using hsl', () => {
			...
			expect(fadeColorByDistance(red, green, 1 / 6)).toEqual([255, 255, 0]);
			expect(fadeColorByDistance(red, green, 1)).toEqual(green);
			expect(fadeColorByDistance(blue, green, 1 / 6)).toEqual([0, 255, 255]);
			expect(fadeColorByDistance(red, blue, 1 / 6)).toEqual([255, 0, 255]);
		...
		it('should take easing', () => {
			expect(fadeColorByDistance(red, green, 1 / 6, v => v / 2)).toEqual([255, 128, 0]);
		});
	});
	...
	describe('fadeColorByDistanceLazy', () => {
		...
		it('should fade to color using hsl', () => {
			...
			expect(fadeColorByDistanceLazy(red, green, 1 / 6)).toEqual([255, 255, 0]);
			expect(fadeColorByDistanceLazy(red, green, 1)).toEqual(green);
			expect(fadeColorByDistanceLazy(blue, green, 1 / 6)).toEqual([0, 255, 255]);
			expect(fadeColorByDistanceLazy(red, blue, 1 / 6)).toEqual([255, 0, 255]);
		...
		it('should take easing', () => {
			expect(fadeColorByDistanceLazy(red, green, 1 / 6, v => v / 2)).toEqual([255, 128, 0]);
		});
	});
