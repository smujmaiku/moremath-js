...
describe('common', () => {
	...
	describe('getProgressAlong', () => {
		it('should return progress along a line', () => {
			expect(getProgressAlong(2, 1, 3)).toEqual(0.5);
			expect(getProgressAlong(1, 1, 3)).toEqual(0);
			expect(getProgressAlong(1, 2, 3)).toEqual(-1);
			expect(getProgressAlong(0, 0, 0)).toEqual(0);
			expect(getProgressAlong(1, 0, 1)).toEqual(1);
			expect(getProgressAlong(NaN, 2, 3)).toEqual(NaN);
			expect(getProgressAlong(1, NaN, 3)).toEqual(NaN);
		});
	});
